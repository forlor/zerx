...
public CaffeineSpec getCaffeine() {
        return caffeine;
    }
public void setCaffeine(CaffeineSpec caffeine) {
        this.caffeine = caffeine;
    }

public Map<String, Duration> getCustomTtls() {
        return customTtls;
    }
public void setCustomTtls(Map<String, Duration> customTtls) {
